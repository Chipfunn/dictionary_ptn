...
while True:
    ...
    if user_choice == 1:
        ...
        if name in catalog:
            print("данная старна ужен есть в словаре ")
        else:
        ...
        name = input("введите название страны ")
        if name in catalog:
            print(f"Столица страны {name} - {catalog.get(name)}")
        else:
            print("Данные о старне отсутствуют")
        ...
        if name in catalog:
            ...
            print("Страна в каталоге отсутствует")

    elif user_choice == 4:
        for key,val in catalog.items():
            print(f"Старана{key}, Столица{val}")
